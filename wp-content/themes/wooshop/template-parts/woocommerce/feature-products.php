                ...
                <div class="row">
                    ...
                    <?php foreach ($products as $product) : ?>
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            ...
                            <article <?php post_class('card h-100 border-0 product-card', $product_id); ?> >

                                <a class="text-decoration-none" href="<?php echo esc_url($product_url); ?>">
                                ...
                                <div class="card-body d-flex flex-column p-3 p-md-4">
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <a
                                                class="btn btn-primary btn-wooshop w-100"
                                                href="<?php echo esc_url($product_url); ?>"
                                        >
