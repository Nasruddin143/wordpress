...
<section class="wooshop-slider" aria-label="<?php esc_attr_e('Featured content', 'wooshop'); ?>">
    <div id="wooshop-slider" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        <?php if (count($slides) > 1) : ?>
            <div class="carousel-indicators">
                <?php foreach ($slides as $index => $slide) : ?>
                    <button type="button" data-bs-target="#wooshop-slider"
        ...
        <div class="carousel-inner">
            <?php foreach ($slides as $index => $slide) : ?>
                <?php $image = get_the_post_thumbnail_url($slide->ID, 'full'); ?>
