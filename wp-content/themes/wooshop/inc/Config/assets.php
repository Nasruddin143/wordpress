 ...
 *
 * Defines all frontend styles and scripts.
 *
 * @package WooShop
 */
...
return [
    ...
    'styles' => [
        ...
        'bootstrap' => [
            'path' => 'assets/build/css/bootstrap.min.css',
            'deps' => [],
            'condition' => 'always',
        ],
    ...
    'scripts' => [
        ...
        'bootstrap' => [
            'path' => 'assets/build/js/bootstrap.bundle.min.js',
            'deps' => [],
            'condition' => 'always',
            'in_footer' => true,
            'strategy' => 'defer',
        ...
        /*
         * -----------------------------------------------------
         * WooShop Application JavaScript
         * -----------------------------------------------------
         */
