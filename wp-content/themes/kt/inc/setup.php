...
/**
 * -----------------------------------------------------------------------------
 * THEME SETUP (Enterprise Hybrid Optimized)
 * Compatible with:
 * - Rank Math SEO
 * - WPBakery Page Builder
 * - Classic + Hybrid Architecture
 * - CPT (Air Coolers, Sewing Machines)
 * -----------------------------------------------------------------------------
 */
...
if (!function_exists('kt_setup')):
	...
	function kt_setup()
	{
		...
		add_theme_support('title-tag'); // Rank Math controls meta title
...
/**
 * -----------------------------------------------------------------
 * Remove WPBakery noscript animation CSS from <head>
 * -----------------------------------------------------------------
 */

add_action('init', function () {

	// Remove WPBakery noscript tag
	remove_action('wp_head', 'vc_animate_when_almost_visible');

}, 999);

/**
 * -----------------------------------------------------------------------------
 * CONTENT WIDTH (SEO + Layout Optimization)
 * -----------------------------------------------------------------------------
 */
...
add_action('after_setup_theme', 'kt_content_width', 0);