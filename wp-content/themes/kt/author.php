    ...
    <div class="page-content-wrapper py-5">
        <div class="container">
            ...
            <header class="entry-header">
                ...
                <!-- Page Title -->
                <h1 class="entry-title fw-semibold text-dark">Articles by <?php echo esc_html($curauth->display_name); ?></h1>
            </header>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="small mb-2">In <?php the_category(', '); ?> by <?php the_author(); ?></div>
