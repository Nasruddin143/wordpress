...
/**
 * --------------------------------------------
 * VC ELEMENT: Client Testimonials (Swiper)
 * --------------------------------------------
 */

if (defined('WPB_VC_VERSION')) {

    add_action('vc_before_init', 'kt_vc_client_testimonials');
    function kt_vc_client_testimonials()
    {
        ...
        vc_map([
            ...
            'description' => __('Client Testimonials Carousel (Swiper)', 'kt'),
            ...
            'params' => [
                ...
                [
                    'type' => 'textfield',
                    'heading' => __('Number of Testimonials', 'kt'),
                    'param_name' => 'count',
                    'value' => '10',
                ],
                ...
                [
                    'type' => 'textfield',
                    'heading' => __('Google Review Url', 'kt'),
    ...
    add_shortcode('client_testimonials', 'kt_client_testimonials_shortcode');

    function kt_client_testimonials_shortcode($atts)
    {
        kt_ensure_swiper_loaded();

        $atts = shortcode_atts(
            array(
                'title' => esc_html('What our clients say?'),
                'desc' => '',
                'count' => 10,
                'autoplay' => 'true',
                'speed' => 4000,
                                ...
                                <div class="card h-100 kt-testimonial-card border-0 shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3 align-items-center">
                                            ...
                                            <img src="<?php echo esc_url(get_template_directory_uri() . '/images/g.webp'); ?>"
                ...
                <div class="google-reviews">
                    ...
                    <?php if ($atts['btn_google_review']): ?>
                        <a href="<?php echo esc_html($atts['btn_google_review']); ?>" target="_blank" rel="noopener nofollow"
                            title="Review us on Google" class="btn btn-outline-primary rounded-pill px-3" role="button">
