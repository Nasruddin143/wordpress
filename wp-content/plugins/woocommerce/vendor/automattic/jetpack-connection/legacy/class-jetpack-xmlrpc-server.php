...
class Jetpack_XMLRPC_Server {
	...
	public function xmlrpc_methods( $core_methods ) {
		...
		/**
		 * Filters the XML-RPC methods available to Jetpack for requests signed both with a blog.php token or a user token.
		 *
		 * @since 1.7.0
		 ...
		 * @param array         $jetpack_methods XML-RPC methods available to the Jetpack Server.
		 * @param array         $core_methods    Available core XML-RPC methods.
		 * @param \WP_User|bool $user            Information about the user authenticated in the request. False if authenticated with blog.php token.
		 */
	...
	/**
	 * This is a substitute for remote_register() when the blog.php is already registered which returns an error code
	 ...
	 *
	 * Disconnect this blog.php from the connected wordpress.com account
	 *
