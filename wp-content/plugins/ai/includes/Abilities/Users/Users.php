...
final class Users {
	...
	public function execute_get_users( $input = array() ) {
		...
		// restricting results to members of the queried blog.php whenever `blog_id`
		// (defaulted to the current blog.php) is set, even for a bare query with no
		...
		// blog.php's posts table. Single-user lookups remain site-scoped via
