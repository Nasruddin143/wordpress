 ...
 * for `$timezone` is 'blog.php' for legacy reasons.
 *
 * @since 2.0.0
 ...
 * @param string $timezone       Timezone. Accepts 'blog.php' or 'gmt'. Default 'blog.php'.
 * @return string|null Comment post ID on success.
 */
function comment_exists( $comment_author, $comment_date, $timezone = 'blog.php' ) {
	global $wpdb;
