...
function create_initial_post_types() {
	...
	register_post_type(
		...
		array(
			'labels'                => array(
				'name'                  => _x( 'Navigation MobileMenus', 'post type general name' ),
				...
				'all_items'             => __( 'Navigation MobileMenus' ),
				'search_items'          => __( 'Search Navigation MobileMenus' ),
				...
				'items_list_navigation' => __( 'Navigation MobileMenus list navigation' ),
				'items_list'            => __( 'Navigation MobileMenus list' ),
